    ...
    <div className="flex items-center justify-center min-h-[80vh] p-4 animate-vert-fade-in">
      <div className="w-full max-w-md bg-white border border-zinc-200 shadow-xl shadow-zinc-200/40 rounded-2xl p-7 md:p-8">
        ...
        <div className="text-center mb-7">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-zinc-900 tracking-tight">Create your channel</h1>
          <p className="text-zinc-500 text-sm mt-1.5">Join Vert and start sharing portrait video</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-zinc-300 rounded-lg text-sm font-medium text-zinc-700 bg-white hover:bg-zinc-50 hover:border-zinc-400 transition-colors active:scale-95 duration-100"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="email" className="text-zinc-700 mb-1.5 block text-sm font-medium">
              Email
            </Label>
            <Input
              id="email"
          ...
          <div>
            <Label htmlFor="username" className="text-zinc-700 mb-1.5 block text-sm font-medium">
              Username
            </Label>
            <Input
              id="username"
          ...
          <div>
            <Label htmlFor="confirm-password" className="text-zinc-700 mb-1.5 block text-sm font-medium">
              Confirm Password
            </Label>
            <Input
              id="confirm-password"
