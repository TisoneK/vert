@echo off
rem ledger-collab-check.cmd -- policy-free launcher for ledger-collab-check.ps1 (Windows).
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0ledger-collab-check.ps1" %*
exit /b %ERRORLEVEL%
